...
public interface FarmActivityService {
    FarmActivity create(FarmActivity farmActivity);
    Page<FarmActivity> findAll(int page, int size, String sort, String sortDirection);
    FarmActivity update(UUID id, FarmActivity farmActivity);
    void delete(UUID id);
    void deleteAll();
    void deleteMany(List<FarmActivity> farmActivities);
    Page<FarmActivity> findByFarm(Farm farm, int page, int size, String sort, String sortDirection);
}
